...
Modern Day Roofing. Two offices: Christiansburg (80 College St. STE R, 24073) and Roanoke (2740 Franklin Rd SW, 24014). Main line (540) 553-6007. Hours M-F 8:30am-5pm. 270+ five-star Google reviews (5.0 rating). Founded 2019. GAF Master Elite (top 2% nationwide). One of just 127 contractors to earn 3-Star President's Club status with GAF in 2026. BBB A+.

SERVICE AREA: Christiansburg, Blacksburg, Radford, Salem, Roanoke, Floyd, Dublin, Pulaski, Wytheville, Bedford, Hollins, Cave Spring, Bonsack, Pearisburg, Smith Mountain Lake, and surrounding Southwest Virginia.
